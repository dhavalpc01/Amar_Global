    ...
    <footer className="relative bg-navy-900 border-t border-slate-800/60 overflow-hidden pt-20 pb-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Navigating global commerce with precision. Connecting international markets through safe, fast, and compliant maritime, air, and overland logistic lanes.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="p-2.5 rounded-lg bg-navy-950 border border-slate-850 hover:border-primary-500/50 text-slate-400 hover:text-primary-400 transition-colors" aria-label="LinkedIn">
              ...
              <a href="#" className="p-2.5 rounded-lg bg-navy-950 border border-slate-850 hover:border-primary-500/50 text-slate-400 hover:text-primary-400 transition-colors" aria-label="Twitter">
                <svg viewBox="0 0 24 24" className="w-4 h-4" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>
              </a>
              <a href="#" className="p-2.5 rounded-lg bg-navy-950 border border-slate-850 hover:border-primary-500/50 text-slate-400 hover:text-primary-400 transition-colors" aria-label="Facebook">
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              <li>
                <NavLink to="/" className="text-slate-400 hover:text-primary-400 text-sm transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-primary-500 mr-2 transition-colors" />
                  Home
                </NavLink>
              </li>
              <li>
                <NavLink to="/about" className="text-slate-400 hover:text-primary-400 text-sm transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-primary-500 mr-2 transition-colors" />
                  About Us
                </NavLink>
              </li>
              <li>
                <NavLink to="/contact" className="text-slate-400 hover:text-primary-400 text-sm transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-primary-500 mr-2 transition-colors" />
                  Contact Us
                </NavLink>
              </li>
              <li>
                <a href="#services" className="text-slate-400 hover:text-primary-400 text-sm transition-colors flex items-center group">
                  <span className="w-1.5 h-1.5 rounded-full bg-slate-700 group-hover:bg-primary-500 mr-2 transition-colors" />
                  Our Services
                </a>
              </li>
          ...
          <div className="space-y-4">
            <h3 className="text-white font-semibold text-sm uppercase tracking-wider mb-6">Headquarters</h3>
            <div className="flex items-start space-x-3 text-slate-400 text-sm leading-relaxed">
              <MapPin className="w-4 h-4 text-primary-500 shrink-0 mt-0.5" />
              <span>
                12 Marina Boulevard, Tower 3<br />
            ...
            <div className="flex items-center space-x-3 text-slate-400 text-sm">
              ...
              <a href="mailto:info@zephyrglobal.com" className="hover:text-primary-400 transition-colors">
                info@zephyrglobal.com
              </a>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-white font-semibold text-sm uppercase tracking-wider mb-2">Newsletter</h3>
              <p className="text-slate-400 text-xs leading-relaxed">
                Subscribe to our global trade bulletin for insights on customs, shipping lanes, and tariff alerts.
              </p>
            </div>
        ...
        <div className="pt-8 border-t border-slate-800/40 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 space-y-4 md:space-y-0">
          <div>
            © {new Date().getFullYear()} Zephyr Global Trade. All rights reserved.
          </div>
          <div className="flex space-x-6">
            <a href="#" className="hover:text-slate-350 transition-colors flex items-center">
              Terms & Conditions <ArrowUpRight className="w-3 h-3 ml-0.5 opacity-60" />
            </a>
            <a href="#" className="hover:text-slate-350 transition-colors flex items-center">
              Privacy Policy <ArrowUpRight className="w-3 h-3 ml-0.5 opacity-60" />
            </a>
            <a href="#" className="hover:text-slate-350 transition-colors flex items-center">
              Customs Compliance <ArrowUpRight className="w-3 h-3 ml-0.5 opacity-60" />
            </a>
          </div>
        </div>
      </div>
