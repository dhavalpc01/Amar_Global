...
export default function About() {
  const team = [
    ...
    },
    {
      ...
      linkedin: "#",
      email: "pendelton@zephyrglobal.com"
    }
  ];
  ...
  const milestones = [
    {
      ...
      desc: "Zephyr Global Trade was founded in Singapore, starting with two chartered cargo ships servicing the Singapore-Shanghai routes."
    },
    {
      year: "2018",
