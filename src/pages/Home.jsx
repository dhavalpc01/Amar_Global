...
//     {
//       quote:
//         "Amar Global Trade transformed our electronics supply chain. Their custom clearance speeds in Singapore cut our lead times by 35%. Highly recommended for high-value freight.",
//       author: "Meet Vekariya",
//       role: "Owner, Capital in corporation.",
//       image:
//         "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop",
//     },
//     {
//       quote:
//         "We ship hundreds of cold-chain agricultural goods weekly. Amar's temperature-monitored ocean container service has maintained a perfect 100% integrity record over 2 years.",
//       author: "Ram bhai Odedra",
//       role: "Owner, Axeilon Logistics",
//       image:
//         "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop",
//     },
//     {
//       quote:
//         "Exceptional transparency and real-time updates. Their customs compliance team saved us from significant tariff penalties in North America with their proactive tariff audits.",
//       author: "Parth Desai",
//       role: "Owner, The Frenk",
//       image:
...
//       eta: "18 Days (Ocean)",
//       cost: "Premium Eco",
//       coordinates: { x1: 520, y1: 270, x2: 300, y2: 120 },
//     },
//     {
//       id: 2,
//       name: "Transpacific Air Corridor",
//       origin: "Shanghai (PVG)",
//       dest: "Los Angeles (LAX)",
//       eta: "14 Hours (Air)",
//       cost: "Priority",
//       coordinates: { x1: 560, y1: 180, x2: 110, y2: 160 },
//     },
//     {
//       id: 3,
//       name: "Transatlantic Trade Highway",
//       origin: "Rotterdam (RTM)",
//       dest: "New York (JFK)",
//       eta: "8 Days (Ocean)",
//       cost: "Standard",
//       coordinates: { x1: 300, y1: 120, x2: 170, y2: 140 },
//     },
//   ];
...
//                 Simplifying import & export logistics. Amar Global provides
//                 glassmorphic transparency, compliance management, and fast
//                 customs clearance across six continents.
//               </p>
...
//                 FCL and LCL shipping container services across global shipping
//                 canals. Temp-monitored refrigerated solutions.
//               </p>
//               <NavLink
//                 to="/contact"
//                 className="text-primary-450 text-xs font-semibold flex items-center group-hover:text-primary-350 transition-colors"
//               >
//                 Book Lane{" "}
...
//               <p className="text-slate-400 text-sm leading-relaxed mb-6">
//                 Next-flight out capabilities, cargo consolidation hubs, charter
//                 options, and priority airport handling worldwide.
//               </p>
//               <NavLink
//                 to="/contact"
//                 className="text-primary-450 text-xs font-semibold flex items-center group-hover:text-primary-350 transition-colors"
...
//               </h3>
//               <p className="text-slate-400 text-sm leading-relaxed mb-6">
//                 Cross-border trucking, dry vans, flatbeds, and rail freight
//                 intermodal services backed by real-time GPS tracking.
//               </p>
//               <NavLink
//                 to="/contact"
//                 className="text-primary-450 text-xs font-semibold flex items-center group-hover:text-primary-350 transition-colors"
...
//               </h3>
//               <p className="text-slate-400 text-sm leading-relaxed mb-6">
//                 HS Code classifications, import licenses, tax duties
//                 calculations, customs bonds, and post-clearance audits.
//               </p>
//               <NavLink
//                 to="/contact"
//                 className="text-primary-450 text-xs font-semibold flex items-center group-hover:text-primary-350 transition-colors"
...
//       {/* 2.5 FEATURED PRODUCTS SLIDER */}
//       <section className="py-24 relative overflow-hidden bg-navy-950/20 border-t border-slate-900/60">
//         <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-96 h-96 bg-primary-950/10 rounded-full blur-[100px] pointer-events-none" />
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
//           {/* <div className="flex flex-col md:flex-row md:items-end justify-between mb-16"> */}
//           <div className="flex flex-col md:flex-row md:items-end justify-between mb-8">
//             <div className="space-y-3">
//               <h2 className="text-xs font-bold text-primary-500 uppercase tracking-widest animate-pulse-slow">
//                 Product Catalog
//               </h2>
...
//             {/* <NavLink
//               to="/products"
//               className="text-primary-450 hover:text-primary-350 text-sm font-semibold flex items-center gap-1.5 mt-4 md:mt-0 group"
//             >
...
//           </div>
//           {/* Slider Container */}
//           <div className="relative min-h-[480px] sm:min-h-[380px] md:min-h-[320px]">
//             {featuredProducts.map((prod, idx) => {
//               const isActive = activeProductSlide === idx;
//               return (
//                 <div
//                   key={prod.id}
...
//                       <div className="grid grid-cols-2 gap-4 max-w-sm pt-4 border-t border-slate-850/40 text-xs text-slate-400">
//                         <div>
...
//                         <NavLink
//                           to={`/products/${prod.id}`}
//                           className="inline-flex items-center justify-center px-6 py-3.5 bg-gradient-to-r from-primary-650 to-green-500 hover:from-primary-550 hover:to-green-450 text-white text-xs font-semibold rounded-xl transition-all shadow-md shadow-primary-500/10 group/btn"
//                         >
...
//                       <div className="relative w-full max-w-[320px] aspect-[4/3] sm:aspect-square rounded-2xl glass-panel p-3 border-slate-800/40 overflow-hidden shadow-xl">
//                         <div className="w-full h-full rounded-xl overflow-hidden bg-navy-950 border border-slate-850 flex items-center justify-center">
//                           <img
//                             src={prod.image}
//                             alt={prod.name}
...
//           <div className="flex items-center justify-start space-x-4 mt-8 border-t border-slate-850/40 pt-6">
//             <button
//               onClick={() =>
...
//               {String(activeProductSlide + 1).padStart(2, "0")} /{" "}
...
//                 Amar Global operates scheduled transport routes along major
//                 shipping corridors. Hover over the nodes on the map or click
//                 active routes to check real-time details and transit averages.
//               </p>
...
//                         {hoveredRoute.name}
//                       </span>
//                       <span className="px-2 py-0.5 rounded-full bg-primary-950 text-primary-400 border border-primary-500/20 text-[10px]">
//                         {hoveredRoute.cost}
//                       </span>
//                     </div>
...
//                       <NavLink
//                         to="/contact"
//                         className="text-primary-400 flex items-center hover:underline"
//                       >
//                         Book lane <ArrowRight className="w-3 h-3 ml-0.5" />
//                       </NavLink>
//                     </div>
//                   </div>
//                 ) : (
...
//                   {/* North America */}
//                   <path
//                     d="M 60 70 L 140 70 L 180 120 L 180 160 L 140 180 L 120 180 L 100 220 L 70 190 Z"
//                     fill="currentColor"
//                     opacity="0.3"
//                   />
//                   {/* South America */}
//                   <path
//                     d="M 130 190 L 170 190 L 210 240 L 190 300 L 160 300 L 140 230 Z"
//                     fill="currentColor"
//                     opacity="0.3"
//                   />
//                   {/* Europe */}
//                   <path
//                     d="M 270 60 L 330 60 L 340 110 L 300 130 L 280 110 L 260 100 Z"
//                     fill="currentColor"
//                     opacity="0.3"
//                   />
//                   {/* Africa */}
//                   <path
//                     d="M 270 130 L 310 130 L 350 180 L 360 250 L 330 270 L 310 200 L 280 170 Z"
//                     fill="currentColor"
//                     opacity="0.3"
//                   />
//                   {/* Asia */}
//                   <path
//                     d="M 340 60 L 520 60 L 560 120 L 560 210 L 480 220 L 460 200 L 420 200 L 380 150 L 350 120 Z"
//                     fill="currentColor"
//                     opacity="0.3"
//                   />
//                   {/* Australia */}
//                   <path
//                     d="M 500 240 L 560 240 L 570 290 L 530 295 L 490 270 Z"
//                     fill="currentColor"
//                     opacity="0.3"
//                   />
...
//                           stroke={
//                             isHovered ? "#10B981" : "rgba(255,255,255,0.12)"
//                           }
...
//                     Cargo Volume Estimator
//                   </h3>
//                   <p className="text-xs text-slate-500">
//                     Calculate volumetric weight & dimensional factors instantly
//                   </p>
//                 </div>
//               </div>
...
//                 </div>
//                 <div className="text-center">
//                   <span className="text-[10px] text-primary-400 uppercase font-bold block mb-1">
//                     Chargeable
//                   </span>
//                   <span className="text-base sm:text-lg font-extrabold text-gradient-primary flex items-center justify-center gap-1">
//                     {calcResults.chargeableWeight}{" "}
//                     <small className="text-[10px] font-semibold">kg</small>
//                   </span>
//                 </div>
//               </div>
//             </div>
...
//                 Carriers charge based on either the{" "}
//                 <strong>Actual gross weight</strong> or the{" "}
//                 <strong>Volumetric (dimensional) weight</strong>, whichever is
//                 higher.
//               </p>
//               <ul className="space-y-4">
//                 <li className="flex items-start space-x-3 text-sm">
//                   <div className="w-5 h-5 rounded-full bg-primary-950 text-primary-400 flex items-center justify-center text-xs shrink-0 mt-0.5 border border-primary-500/20 font-bold">
//                     1
//                   </div>
//                   <span className="text-slate-350">
//                     <strong>Air factor (1:5000):</strong> Length × Width ×
//                     Height (cm) / 5000 gives volumetric weight in kg.
//                   </span>
//                 </li>
//                 <li className="flex items-start space-x-3 text-sm">
//                   <div className="w-5 h-5 rounded-full bg-primary-950 text-primary-400 flex items-center justify-center text-xs shrink-0 mt-0.5 border border-primary-500/20 font-bold">
...
//                   </div>
//                   <span className="text-slate-350">
//                     <strong>Ocean factor:</strong> Total volume in Cubic Meters
//                     (CBM) determines ocean bulk lanes.
//                   </span>
//                 </li>
//               </ul>
//               <div className="pt-2">
...
//                       alt={item.author}
//                     /> */}
//                     <div className="w-10 h-10 rounded-full object-cover border border-primary-500/30 shadow-md justify-center items-center flex bg-primary-950 text-primary-400">
...
//               <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
//                 Connect with our trade logistics coordinators to formulate
//                 customs compliance checklists or schedule priority air and ocean
//                 lane allocations.
//               </p>
...
export default function Home() {
  ...
  return (
    <div className="relative">
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[90vh] flex items-center bg-[linear-gradient(to_right,rgba(255,255,255,0.015)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.015)_1px,transparent_1px)] bg-[size:50px_50px] pt-12 overflow-hidden">
        {/* Glowing backgrounds */}
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-primary-950/15 rounded-full blur-[160px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Hero Left */}
            <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
              <div className="inline-flex items-center space-x-2 px-3 py-1.5 rounded-full bg-slate-900/45 backdrop-blur-md border border-white/5 text-xs font-semibold tracking-wider text-primary-400 uppercase animate-fade-in">
                <Activity className="w-3.5 h-3.5 text-primary-500 animate-pulse" />
                <span>Global Freight Network Active</span>
              </div>

              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-[1.1] animate-slide-up">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-slate-200 to-primary-400">
                  Navigating Global
                </span>{" "}
                <br />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary-400 via-primary-500 to-amber-400">
                  Trade Pathways
                </span>
              </h1>
              ...
              <p className="text-slate-350 text-base sm:text-lg max-w-2xl mx-auto lg:mx-0 leading-relaxed animate-slide-up-delayed">
                Simplifying import & export logistics. Amar Global provides
                clear transparency, compliance management, and fast customs
                clearance across six continents.
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2 animate-slide-up-delayed-2">
                <NavLink
                  to="/contact"
                  className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-primary-600 to-amber-500 text-white rounded-xl font-medium hover:from-primary-500 hover:to-amber-450 transition-all transform hover:scale-[1.03] shadow-lg shadow-primary-500/20 text-center flex items-center justify-center gap-2 group"
                >
                  Book a Shipment
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </NavLink>
                <NavLink
                  to="/about"
                  className="w-full sm:w-auto px-8 py-4 bg-slate-900/45 backdrop-blur-md border border-white/5 transition-all duration-300 hover:bg-slate-900/60 hover:border-primary-500/35 hover:shadow-lg hover:shadow-primary-500/10 hover:-translate-y-1 text-slate-250 hover:text-white rounded-xl font-medium text-center"
                >
                  Explore Our Reach
                </NavLink>
              </div>
            ...
            <div className="lg:col-span-5 relative flex items-center justify-center">
              <div className="relative w-full max-w-[450px] aspect-square rounded-3xl bg-slate-900/45 backdrop-blur-md border border-white/5 p-6 border-slate-800/40 overflow-hidden shadow-2xl shadow-navy-950">
                ...
                <div className="absolute bottom-6 left-6 p-4 rounded-xl bg-slate-900/45 backdrop-blur-md border border-white/5 border-white/5 flex items-center space-x-2 text-xs font-semibold text-slate-350">
                  <Anchor className="w-4 h-4 text-primary-500" />
                  <span>S.S. Vanguard Cargo</span>
                </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Ocean Freight Card */}
            <div className="bg-slate-900/45 backdrop-blur-md border border-white/5 transition-all duration-300 hover:bg-slate-900/60 hover:border-primary-500/35 hover:shadow-lg hover:shadow-primary-500/10 hover:-translate-y-1 p-8 rounded-2xl relative group">
              <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-primary-500/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="w-12 h-12 rounded-xl bg-primary-950/60 border border-primary-500/20 text-primary-400 flex items-center justify-center mb-6 group-hover:scale-105 transition-transform duration-300">
                <Anchor className="w-6 h-6" />
              </div>
              ...
              <NavLink
                to="/contact"
                className="text-primary-400 text-xs font-semibold flex items-center hover:text-primary-350 transition-colors"
              >
                Book Lane{" "}
                <ArrowRight className="w-3.5 h-3.5 ml-1.5 group-hover:translate-x-1 transition-transform" />
              </NavLink>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center h-full">
                    ...
                    <div className="lg:col-span-7 space-y-6 text-left">
                      ...
                      {/* <div className="pt-4">
                        <NavLink
                          to={`/products/${prod.id}`}
                          className="inline-flex items-center justify-center px-6 py-3.5 bg-gradient-to-r from-primary-650 to-primary-500 hover:from-primary-550 hover:to-primary-450 text-white text-xs font-semibold rounded-xl transition-all shadow-md shadow-primary-500/10 group/btn"
                        >
                          Detailed Specifications
                          <ArrowRight className="w-4 h-4 ml-2 group-hover/btn:translate-x-1 transition-transform" />
                        </NavLink>
                    ...
                    {/* Right Image */}
                    <div className="lg:col-span-5 flex justify-center">
                      <div className="relative w-full max-w-[320px] aspect-[4/3] sm:aspect-square rounded-2xl bg-slate-900/45 backdrop-blur-md border border-white/5 p-3 border-slate-800/40 overflow-hidden shadow-xl">
                        <div className="w-full h-full rounded-xl overflow-hidden bg-navy-950 border border-slate-850 flex items-center justify-center">
                          <img
                            src={prod.image}
                            alt={prod.name}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              {/* Route Details Card based on Hover */}
              <div className="p-5 rounded-2xl bg-slate-900/45 backdrop-blur-md border border-white/5 border-white/5 min-h-[140px] flex flex-col justify-center">
                {hoveredRoute ? (
                  <div className="space-y-3 animate-fade-in">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-primary-400 uppercase tracking-wider">
            ...
            {/* Right side map visualization (Custom SVG Map outline) */}
            <div className="lg:col-span-7 flex justify-center relative">
              <div className="w-full aspect-[640/320] bg-slate-900/45 backdrop-blur-md border border-white/5 rounded-3xl p-4 border-slate-800/40 bg-navy-900/20 overflow-hidden relative shadow-inner">
                {/* World map stylized outline representing continents */}
                <svg
                  className="w-full h-full text-slate-800/40"
                  viewBox="0 0 640 320"
                    ...
                    return (
                      <g key={route.id}>
                        ...
                        <path
                          d={`M ${route.coordinates.x1} ${route.coordinates.y1} Q ${(route.coordinates.x1 + route.coordinates.x2) / 2} ${(route.coordinates.y1 + route.coordinates.y2) / 2 - 40} ${route.coordinates.x2} ${route.coordinates.y2}`}
                          stroke={
                            isHovered ? "#F08A26" : "rgba(255,255,255,0.12)"
                          }
                          strokeWidth={isHovered ? "2.5" : "1.5"}
                          fill="none"
                          className={isHovered ? "map-route-line" : ""}
      ...
      <section className="py-24 relative overflow-hidden bg-navy-900/30 border-t border-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Calculator Panel */}
            <div className="lg:col-span-7 bg-slate-900/45 backdrop-blur-md border border-white/5 p-8 rounded-3xl border-slate-800/40 bg-navy-900/60 shadow-2xl relative">
              <div className="absolute top-0 right-0 w-48 h-48 bg-primary-950/20 rounded-full blur-[80px] pointer-events-none" />
              ...
              <div className="grid grid-cols-3 gap-4 p-5 rounded-2xl bg-navy-950/80 border border-slate-850">
                ...
                <div className="text-center">
                  ...
                  <span className="text-base sm:text-lg font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-primary-450 via-primary-500 to-amber-400 flex items-center justify-center gap-1">
                    {calcResults.chargeableWeight}{" "}
                    <small className="text-[10px] font-semibold">kg</small>
                  </span>
                </div>
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="pt-2">
                <NavLink
                  to="/contact"
                  className="inline-flex items-center text-primary-400 hover:text-primary-350 text-sm font-semibold group"
                >
                  Request a Formal Rate Sheet
                  <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                </NavLink>
      ...
      {/* 6. FINAL CALL TO ACTION */}
      <section className="py-24 relative overflow-hidden bg-gradient-to-t from-navy-950 to-navy-900">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.01)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.01)_1px,transparent_1px)] bg-[size:50px_50px] opacity-30 pointer-events-none" />
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="bg-slate-900/45 backdrop-blur-md border border-white/5 p-10 sm:p-16 rounded-3xl border-slate-800/40 bg-gradient-to-tr from-navy-950 via-navy-900/80 to-primary-950/20 text-center relative overflow-hidden shadow-2xl">
            <div className="absolute top-[-20%] left-[-20%] w-[300px] h-[300px] bg-primary-950/20 rounded-full blur-[80px] pointer-events-none" />

            <div className="max-w-2xl mx-auto space-y-8">
              <Award className="w-12 h-12 text-primary-450 mx-auto animate-pulse-slow" />
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <NavLink
                  to="/contact"
                  className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-primary-600 to-amber-500 text-white rounded-xl font-semibold hover:from-primary-500 hover:to-amber-450 transition-all shadow-lg shadow-primary-500/10 text-center"
                >
                  Consult an Expert
                </NavLink>
                <NavLink
